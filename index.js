const apiKey = "1cb2a8517c8c94b909510dea40405a4b";
...
//Create a move card html template
...
async function loadMoreResults() {
    ...
    page++;
    const seachTerm = query.value;
    const url = searchTerm ? `${searchResult}${seatchTerm}&{page}
...
async function handleSearch (e){
    e.preventDefaults();
    const seachTerm = query.value.trim();
    if(seachTerm){
        isSearching = true;
        clearResults();
